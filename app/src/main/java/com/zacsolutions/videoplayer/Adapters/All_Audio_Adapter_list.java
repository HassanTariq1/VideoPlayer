...
public class All_Audio_Adapter_list extends RecyclerView.Adapter<All_Audio_Adapter_list.categriesViewHolder>{

    ArrayList<VideoFile> arrayList;
    Activity activity;
    All_Videos_Activity all_videos_activity = new All_Videos_Activity();
    public All_Audio_Adapter_list(ArrayList<VideoFile> arrayList, Activity activity) {
    ...
    public categriesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view=inflater.inflate(R.layout.audio_item_list,parent,false);
